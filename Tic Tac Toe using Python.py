...
def row_mark(board, player=other): 
    for x in range(0,m): 
        for y in range(0,n-k+1):
            win = True
            step = 0
...
def diag_mark(board, player=other): 
    win = True
    step = 0
    pos = -1  #To store position where mark can be made
    ...
    if m == n and m==k:
        ...
        if (step + 1) != k:
            win = False
        if win == True and board[pos,pos] == 0:
        ...
        if (step + 1) != k:
            win = False
        if win == True and board[pos,m-1-pos] == 0:
        ...
        if k>min(m,n):
            ...
            for x in range(0,m-k+1):
                for y in range(0,n-k+1):
                    ...
                    if step + 1 != k:
                        win = False
                    if win == True and board[x+pos,y+pos] == 0:
...
def row_check(board, player=user): 
    for x in range(0,m): 
        for y in range(0,n-k+1):
            win = True
            step = 0
...
# Checks whether the player has k-1 of their marks in a vertical row 
def col_check(board, player=user):
    for x in range(0,n): 
        for y in range(0,m-k+1):
            win = True
            step = 0
